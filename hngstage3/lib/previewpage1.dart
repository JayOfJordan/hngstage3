...
class PreviewPage1 extends StatefulWidget {
  const PreviewPage1({super.key});

  @override
  State<PreviewPage1> createState() => _PreviewPage1State();
}

class _PreviewPage1State extends State<PreviewPage1> {
  final List<Wallpaper> _wallpapers = [
    Wallpaper(
      id: 'nature_1',
      name: 'Mountain Meadow',
      category: 'Nature',
      imagePath: 'assets/nature1.jpeg',
      description: 'Vibrant yellow flowers carpeting a valley with majestic mountains in the background under a bright sky.',
      tags: ['Mountains', 'Flowers', 'Meadow', 'Sunny', 'Landscape', 'Green'],
    ),
    Wallpaper(id: 'nature_2', name: 'Misty Lake', category: 'Nature', imagePath: 'assets/nature2.jpeg', description: 'A serene lake surrounded by evergreen trees, with a light mist hanging over the water.', tags: ['Lake', 'Forest', 'Mist']),
    Wallpaper(id: 'nature_3', name: 'Forest Path', category: 'Nature', imagePath: 'assets/nature3.jpeg', description: 'A tranquil path winding through a dense forest, with sunlight filtering through the canopy.', tags: ['Forest', 'Path', 'Sunlight']),
    Wallpaper(id: 'nature_4', name: 'Coastal Cliffs', category: 'Nature', imagePath: 'assets/nature4.jpeg', description: 'Dramatic cliffs meeting the ocean, with waves crashing against the rocks under a colorful sunset.', tags: ['Cliffs', 'Ocean', 'Sunset']),
    Wallpaper(id: 'nature_5', name: 'Starry Night Sky', category: 'Nature', imagePath: 'assets/nature5.jpeg', description: 'A breathtaking view of the Milky Way galaxy over a calm, silhouetted landscape.', tags: ['Stars', 'Night', 'Galaxy']),
    Wallpaper(id: 'nature_6', name: 'Rocky Seashore', category: 'Nature', imagePath: 'assets/nature6.jpeg', description: 'A rugged seashore with a unique rock formation and calm waters stretching to the horizon.', tags: ['Sea', 'Rocks', 'Coast']),
    Wallpaper(id: 'nature_7', name: 'Autumn River', category: 'Nature', imagePath: 'assets/nature.jpeg', description: 'A calm river flowing through a forest ablaze with brilliant autumn colors.', tags: ['River', 'Autumn', 'Trees']),
  ];
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Nature', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                const Spacer(),
