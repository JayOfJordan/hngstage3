...
class PreviewPage4 extends StatefulWidget {
  const PreviewPage4({super.key});

  @override
  State<PreviewPage4> createState() => _PreviewPage4State();
}

class _PreviewPage4State extends State<PreviewPage4> {
  final List<Wallpaper> _wallpapers = [
    Wallpaper(
      ...
      description: 'A stunning visualization of a distant nebula, where cosmic dust and gas form celestial clouds of vibrant color.',
      tags: ['Nebula', 'Galaxy', 'Stars', 'Cosmos', 'Universe'],
    ),
  ...
  void initState() {
    ...
    // Sync initial favorite state with provider
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Space', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                const Spacer(),
