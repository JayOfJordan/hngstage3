...
class PreviewPage3 extends StatefulWidget {
  const PreviewPage3({super.key});

  @override
  State<PreviewPage3> createState() => _PreviewPage3State();
}

class _PreviewPage3State extends State<PreviewPage3> {
  final List<Wallpaper> _wallpapers = [
    Wallpaper(
      ...
      description: 'A stunning cityscape view as evening approaches, with illuminated skyscrapers and bustling city streets below.',
      tags: ['City', 'Skyscrapers', 'Dusk', 'Lights', 'Metropolis'],
    ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Urban', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                const Spacer(),
