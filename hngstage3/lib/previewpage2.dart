...
class _PreviewPage2State extends State<PreviewPage2> {
  final List<Wallpaper> _wallpapers = [
    Wallpaper(
      ...
      description: 'A vibrant and dynamic flow of intersecting colors, creating a sense of motion and energy.',
      tags: ['Colorful', 'Modern', 'Digital Art', 'Fluid', 'Gradient'],
    ),
   ];
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Abstract', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                const Spacer(),
