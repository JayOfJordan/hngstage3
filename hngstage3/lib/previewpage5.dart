...
class PreviewPage5 extends StatefulWidget {
  const PreviewPage5({super.key});

  @override
  State<PreviewPage5> createState() => _PreviewPage5State();
}

class _PreviewPage5State extends State<PreviewPage5> {
  final List<Wallpaper> _wallpapers = [
    Wallpaper(
      ...
      description: 'A clean and simple composition with subtle color gradients, emphasizing negative space and calm tones.',
      tags: ['Minimal', 'Clean', 'Simple', 'Abstract', 'Calm'],
    ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Minimalist', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black87)),
                const Spacer(),
